...
if __name__ == "__main__":
    ...
    print(num_query, num_classes, camera_num, view_num)
    ...
    # model.load_param(
    #     "/homes/hnakayama/tracking_practice/gta/Duke_baseline_ViT-B-16_60.pth"
    # )
    model.load_param(
        "/homes/hnakayama/tracking_practice/gta/Duke_clipreid_ViT-B-16_60.pth"
    )
    # model.load_param(
    #     "/homes/hnakayama/tracking_practice/gta/Duke_clipreid_12x12sie_ViT-B-16_60.pth"
    # )
    ...
    #         logger.info(
    #             "rank_1:{}, rank_5 {} : trial : {}".format(rank_1, rank5, mAP, trial)
    #         )
    #     logger.info(
